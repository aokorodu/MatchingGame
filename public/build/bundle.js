...
var app = (function () {
    ...
    */
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(rect, "fill", "#288DDD");
    			attr_dev(rect, "fill-opacity", "1");
    			attr_dev(rect, "stroke", "black");
    			add_location(rect, file$1, 99, 4, 1661);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	let if_block = !/*state*/ ctx[3].selected && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(rect, "stroke", "black");
    			add_location(rect, file$1, 82, 2, 1383);
    			attr_dev(text_1, "x", "0");
    			attr_dev(text_1, "y", "0");
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*position*/ 4 && g_transform_value !== (g_transform_value = "translate(" + (parseInt(/*position*/ ctx[2].x) + /*w*/ ctx[4] / 2) + ", " + parseInt(/*position*/ ctx[2].y + /*h*/ ctx[5] / 2) + ")")) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function lock() {
    		$$invalidate(3, state.locked = true, state);
    		$$invalidate(3, state);
    	}
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 149, 1, 2975);
    			add_location(g, file, 151, 2, 3115);
    			...
    			add_location(svg_1, file, 150, 1, 3033);
    			attr_dev(div1, "class", "deal-button svelte-zktg06");
    			add_location(div1, file, 164, 1, 3364);
    			attr_dev(main, "class", "svelte-zktg06");
    			add_location(main, file, 148, 0, 2967);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
