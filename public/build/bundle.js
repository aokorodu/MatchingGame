...
var app = (function () {
    ...
    */
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(rect0, file$2, 85, 2, 1410);
    			attr_dev(text_1, "x", "0");
    			attr_dev(text_1, "y", "0");
    			...
    			add_location(text_1, file$2, 98, 2, 1571);
    			...
    			add_location(rect1, file$2, 109, 2, 1753);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(text_1, "dominant-baseline", "middle");
    			attr_dev(text_1, "text-anchor", "middle");
    			add_location(text_1, file$1, 16, 2, 249);
    			attr_dev(g, "transform", g_transform_value = "translate(" + /*x*/ ctx[0] + ", " + /*y*/ ctx[1] + ")");
    			add_location(g, file$1, 15, 0, 211);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*duration*/ 8) {
    			$$invalidate(2, remaining = duration - elapsed);
    		}
    	};

    	return [x, y, remaining, duration, start, stop];
    }
    ...
    // (153:2) {#each symbols as symbol, index}
    function create_each_block(ctx) {
    	let card;
    	let index = /*index*/ ctx[38];
    	let current;
    	const assign_card = () => /*card_binding*/ ctx[16](card, index);
    	const unassign_card = () => /*card_binding*/ ctx[16](null, index);

    	let card_props = {
    		x: 25 + /*index*/ ctx[38] * .5,
    		y: /*h*/ ctx[9] / 2 - /*index*/ ctx[38] * .5,
    		index: /*index*/ ctx[38],
    		symbol: /*symbol*/ ctx[36]
    	};

    	card = new Card({ props: card_props, $$inline: true });
    	assign_card();
    	card.$on("cardClick", /*handleCardClick*/ ctx[11]);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(153:2) {#each symbols as symbol, index}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 149, 1, 3011);
    			add_location(g, file, 151, 2, 3151);
    			attr_dev(svg_1, "width", /*svgWidth*/ ctx[6]);
    			attr_dev(svg_1, "height", /*svgHeight*/ ctx[7]);
    			attr_dev(svg_1, "viewBox", "0 0 " + /*w*/ ctx[8] + " " + /*h*/ ctx[9]);
    			attr_dev(svg_1, "class", "svelte-zktg06");
    			add_location(svg_1, file, 150, 1, 3069);
    			attr_dev(div1, "class", "deal-button svelte-zktg06");
    			add_location(div1, file, 165, 1, 3441);
    			attr_dev(main, "class", "svelte-zktg06");
    			add_location(main, file, 148, 0, 3003);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(timer, svg_1, null);
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*h, symbols, cardArray, handleCardClick*/ 3592) {
    				each_value = /*symbols*/ ctx[10];
    				validate_each_argument(each_value);
    				let i;
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('svgWidth' in $$props) $$invalidate(6, svgWidth = $$props.svgWidth);
    		if ('svgHeight' in $$props) $$invalidate(7, svgHeight = $$props.svgHeight);
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*columns*/ ctx[13] === undefined && !('columns' in props)) {
