...
var app = (function () {
    ...
    */
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(rect0, "height", /*h*/ ctx[2]);
    			attr_dev(rect0, "rx", "10");
    			attr_dev(rect0, "ry", "10");
    			...
    			attr_dev(rect1, "rx", "10");
    			attr_dev(rect1, "ry", "10");
    			attr_dev(rect1, "width", /*w*/ ctx[1]);
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*w*/ 2 && rect0_x_value !== (rect0_x_value = -/*w*/ ctx[1] / 2)) {
    				attr_dev(rect0, "x", rect0_x_value);
    			}

    			if (dirty & /*h*/ 4 && rect0_y_value !== (rect0_y_value = -/*h*/ ctx[2] / 2)) {
    			...
    			if (dirty & /*w*/ 2 && rect1_x_value !== (rect1_x_value = -/*w*/ ctx[1] / 2)) {
    				attr_dev(rect1, "x", rect1_x_value);
    			}

    			if (dirty & /*h*/ 4 && rect1_y_value !== (rect1_y_value = -/*h*/ ctx[2] / 2)) {
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ['symbol', 'x', 'y', 'w', 'h', 'index'];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Card> was created with unknown prop '${key}'`);
    	});

    	function rect1_binding($$value) {
    	...
    	$$self.$inject_state = $$props => {
    		if ('holder' in $$props) $$invalidate(3, holder = $$props.holder);
    ...
    function create_fragment$2(ctx) {
    	let g;
    	let text_1;
    	let t0_value = (/*remaining*/ ctx[2] < 10 ? "0" : "") + "";
    	let t0;
    	let t1;
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(text_1, "text-anchor", "middle");
    			attr_dev(text_1, "class", "svelte-ka21ck");
    			add_location(text_1, file$2, 48, 2, 848);
    			attr_dev(g, "transform", g_transform_value = "translate(" + /*x*/ ctx[0] + ", " + /*y*/ ctx[1] + ")");
    			add_location(g, file$2, 47, 0, 810);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*remaining*/ 4 && t0_value !== (t0_value = (/*remaining*/ ctx[2] < 10 ? "0" : "") + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*remaining*/ 4) set_data_dev(t1, /*remaining*/ ctx[2]);
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ['x', 'y', 'duration'];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$2.warn(`<Timer> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*duration, elapsed*/ 136) {
    			$$invalidate(2, remaining = duration - elapsed);
    		}
    	};

    	return [x, y, remaining, duration, isRunning, start, stop, elapsed];
    }
    ...
    /* src/Bumper.svelte generated by Svelte v3.48.0 */

    const { console: console_1$1 } = globals;
    const file$1 = "src/Bumper.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			g0 = svg_element("g");
    			text_1 = svg_element("text");
    			t = text(/*displayMessage*/ ctx[0]);
    			attr_dev(rect, "x", "0");
    			attr_dev(rect, "y", "0");
    			attr_dev(rect, "width", "500");
    			attr_dev(rect, "height", "500");
    			attr_dev(rect, "fill", "black");
    			attr_dev(rect, "fill-opacity", ".8");
    			add_location(rect, file$1, 26, 2, 504);
    			attr_dev(text_1, "id", "holder");
    			attr_dev(text_1, "transform", "scale(0)");
    			attr_dev(text_1, "x", "0");
    			attr_dev(text_1, "y", "0");
    			attr_dev(text_1, "fill", "lightblue");
    			attr_dev(text_1, "stroke", "none");
    			attr_dev(text_1, "font-size", "70");
    			attr_dev(text_1, "font-weight", "900");
    			attr_dev(text_1, "dominant-baseline", "middle");
    			attr_dev(text_1, "text-anchor", "middle");
    			attr_dev(text_1, "class", "svelte-1xk9n2r");
    			add_location(text_1, file$1, 28, 4, 622);
    			attr_dev(g0, "transform", "translate(250 250)");
    			add_location(g0, file$1, 27, 2, 583);
    			add_location(g1, file$1, 25, 0, 498);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*displayMessage*/ 1) set_data_dev(t, /*displayMessage*/ ctx[0]);
    		},
    		i: noop,
    		o: noop,
    		d: function destroy(detaching) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$1.warn(`<Bumper> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$inject_state = $$props => {
    		if ('message' in $$props) $$invalidate(1, message = $$props.message);
    		if ('winningMessage' in $$props) $$invalidate(2, winningMessage = $$props.winningMessage);
    		if ('losingMessage' in $$props) $$invalidate(3, losingMessage = $$props.losingMessage);
    		if ('holder' in $$props) holder = $$props.holder;
    		if ('displayMessage' in $$props) $$invalidate(0, displayMessage = $$props.displayMessage);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*message*/ 2) {
    			$$invalidate(0, displayMessage = message == 0 ? losingMessage : winningMessage);
    		}
    	};
    ...
    class Bumper extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { message: 1 });
    	...
    	get message() {
    		throw new Error("<Bumper>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set message(value) {
    		throw new Error("<Bumper>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			const card_changes = {};
    			if (dirty[0] & /*cardWidth*/ 1) card_changes.w = /*cardWidth*/ ctx[0];
    			if (dirty[0] & /*cardHeight*/ 2) card_changes.h = /*cardHeight*/ ctx[1];
    			...
    			if (dirty[0] & /*h, cardWidth, cardHeight, symbols, cardArray, handleCardClick*/ 426051) {
    				...
    				for (i = 0; i < each_value.length; i += 1) {
    					...
    					if (each_blocks[i]) {
    						...
    						each_blocks[i].c();
    						transition_in(each_blocks[i], 1);
    						each_blocks[i].m(svg_1, each_1_anchor);
    					}
    				}
